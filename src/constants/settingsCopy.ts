...
export const SETTINGS_COPY = {
  ...
  ttsTitle: 'TTS · 语音播报',
  ttsAuthHint: '复用上方 ASR 的 API Key；鉴权见',
  ttsDocLink: '豆包语音合成 HTTP/SSE',
  ttsKeyHint: '与 ASR 共用 API Key，请在 ASR 区块填写并保存',
  ttsResourceIdLabel: 'Resource ID（X-Api-Resource-Id）',
  ttsSpeakerLabel: '音色 Speaker',
  ttsModelLabel: '合成模型',
  ttsModelStandard: '标准版（低延迟）',
  ttsModelExpressive: '表现力增强',
  ttsBroadcastEnabled: '已开启语音播报',
  ttsBroadcastDisabled: '已关闭语音播报',
  ttsConfigureAsrFirst: '请先在设置中配置 ASR API Key',
  ttsSpeakerDenied: '音色未开通，请在设置中更换音色',
  ttsTextTooLong: '回复过长，无法播报',
  ttsQuotaExceeded: '语音合成繁忙，请稍后重试',
  ttsAuthFailed: 'API Key 无效，请检查 ASR 配置',
  ttsNoAudio: '未收到音频数据',
  ttsNetworkError: '无法连接语音合成服务，请检查网络',
  ttsFailed: '语音播报失败，请重试',

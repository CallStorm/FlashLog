...
[![FlashLog 演示视频](assets/demo/flashlog-demo-poster.jpg)](assets/demo/flashlog-demo.mp4)

点击封面播放；若未自动播放，请打开 [演示视频 MP4](assets/demo/flashlog-demo.mp4)（GitHub 文件页支持在线播放）。
